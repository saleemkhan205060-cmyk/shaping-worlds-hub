...
// Do not initialize DOM/session-replay recorders in the Android WebView.
// Their global interaction instrumentation runs on every pointer event and can
// monopolize the WebView UI thread on media-heavy feeds. Browser monitoring
// remains enabled through src/router.tsx.
