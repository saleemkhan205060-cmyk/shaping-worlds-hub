...
>
  ...
  <button
    ...
    className="absolute -right-1 -top-1 h-5 w-5 rounded-full bg-[#117D43] text-white flex items-center justify-center shadow-md border border-white active:scale-90"
    aria-label="Follow"
    >
