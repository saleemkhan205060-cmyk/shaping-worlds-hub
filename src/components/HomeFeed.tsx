...
export function HomeFeed() {
  ...
  return (
    <section className="mt-0 space-y-4">
      {/* Composer */}
      {user && (
        <div className="bg-[#005A35] rounded-2xl border border-[#19D66B] p-4 shadow-sm">
          <textarea
            value={caption}
            ...
            className="w-full resize-none rounded-xl border border-[#19D66B]/60 bg-[#004A2D] px-3 py-3 text-sm text-white placeholder:text-white/50 focus:outline-none focus:border-[#19D66B] focus:ring-1 focus:ring-[#19D66B]/40"
          />
          {preview && file && (
      ...
      <div className="space-y-4">
        ...
        {loading ? (
          ...
          filtered.map((p) => {
            ...
            return (
              <article key={p.id} className="bg-[#005A35] rounded-2xl border border-[#19D66B] overflow-hidden shadow-sm">
                  ...
                  >
                    ...
                    >
                      <img
                        src={p.media_url}
                        alt={p.caption ?? "Post"}
                        className="w-full aspect-[4/5] lg:aspect-[9/16] max-w-[420px] mx-auto object-cover bg-slate-100"
                        loading="lazy"
                      />
                ...
                {p.media_type === "video" && p.media_url && (
                  ...
                  >
                  <div
                    className="relative bg-black aspect-[4/5] lg:aspect-[9/16] max-w-[420px] mx-auto"
                    data-postid={p.id}
                    ref={(el) => {
